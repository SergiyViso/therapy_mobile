...
import { previousWeakRatingList } from '../../utils/utils'
...
const Goals = (props) => {
    ...
    const [goalsArr, setGoalsArr] = useState(goalsList)
    ...
    const addGoalsByRating = () => {
        if (arrToSend.length == 0) {
            errorToast("Please select atleast one Goals! ")
        }
        else {
            ...
            dispatch(PostSymptomsDetail(token, formdata)).then(async res => {
                ...
                if (res.success == true) {
                    ...
                    // })
                    console.log("toast message for goals",res.message)
                    successToast(res.message)
                    setArrToSend([])
                    // resetMultipleSelect()
                    setLoader(false)
            ...
            <ScrollView>
                ...
                {/* {
                    ...
                    <>
                        ...
                        <DropDownComponent 
                        value={deleteGoal} onSetValue={(value) => setDeleteGoal(value)}
                        ...
                        <View style={styles.bottomBox}>
                                        ...
                                        return (<View style={{ flexDirection: 'column' }}>
...

                                            {
                                                ...
                                                <View style={styles.ratingBox}>
                                                    ...
                                                    {/* {console.log(item,"jdkjgkdkgdgddgdg")} */}
                                                    {
                            ...
                            {/* <View style={{flexDirection:"row",flexWrap:"wrap"}}> */}
                            {
                                ...
                                <>
                                    ...
                                    placeholder='Add your comment about added Goals...'
                                    style={styles.input}
                                    />
                                </>
                            }
