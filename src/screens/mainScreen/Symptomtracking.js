...
const Symptomtracking = () => {
    ...
    // console.log(JSON.stringify(adminSymptoms), "adminSymptomsadminSymptomsadminSymptoms");
    ...
    const addSymptomByRating = async () => {
        if (arrToSend.length == 0) {
            errorToast("Please select at least one symptom")
        }
        else {
        ...
        <SafeAreaView style={commonStyles.mainContainer}>
            ...
            <ScrollView>
                ...
                <View style={styles.topBox}>
                    <Text style={[styles.topText]}>Here is where you will track your symptoms.</Text>
                    <Text style={{
                        fontStyle: 'italic', fontWeight: "400", color: colors.black, top: verticalScale(20), width: "40%",
                        fontSize: moderateScale(12) / fontScalingFactor
                    }}>Not seeing the symptom you want to track? Scroll down to "other" and you can add any symptom you want!</Text>
                    <Image
                ...
                <Text style={styles.addText}>Add symptom to track</Text>
                {/* {
                    alert(selectSymptom)
                } */}
                {
                ...
                <View style={styles.greyLine}></View>
                {
                    ...
                    <>
                        <View style={styles.bottomBox}>
                            <Text style={styles.dropDownTitle}>Select symptom to track</Text>
                            <Text style={styles.dropDownDes}>Here you can track and rate symptoms anytime you like</Text>
                            <TouchableOpacity activeOpacity={0.2} style={styles.customDrawerBox}
                                onPress={() => setSelecting(!selecting)}
                            >
                                <Text style={{ color: '#000' }}>Select symptom</Text>
                                <Image
                                    source={images.downArrrow}
                                    style={{ height: scale(8), width: scale(12) }}
                                    resizeMode='stretch'
            ...
            <Modal
                ...
                <View style={styles.centeredView}>
                    <View style={styles.modalView}>
                        ...
                        <Text style={[styles.dropDownDes, { textAlign: "center", width: "85%" }]}>Here you can add your comment to your selected Symptom to track.</Text>
                        <TextInput
                            value={comment}
                            onChangeText={(v) => setComment(v)}
                            placeholder='Adding commet is optional...'
                        ...
                        <View style={{ flexDirection: "row", justifyContent: "space-between", width: "80%" }}>
                            ...
                            <CommonButtons title={"Add"}
                                ...
                                customStyle={{ height: verticalScale(30), width: "40%", marginVertical: verticalScale(15) }} />
                            <CommonButtons title={"Cancel"}
                                onPress={() => {
                                    setCommentInput(false)
                                    setComment("")
                                }}
                                customStyle={{ height: verticalScale(30), width: "40%", marginVertical: verticalScale(15),backgroundColor:colors.signUpBtn }} />
                        </View>
