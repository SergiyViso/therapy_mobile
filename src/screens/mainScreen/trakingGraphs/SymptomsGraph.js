  ...
  const getGraphData = async (symptomId) => {
    ...
    if (symptomId == '') {
      ...
      if (selectedIndex == 0) {
        ...
        formdata.append('month', selectedMonth ? selectedMonth : selectedMonth);
        formdata.append('year', selectedYear ? selectedYear : selectedYear);
      ...
      try {
        ...
        await dispatch(getSymptomToTrack(token, formdata, symptomId)).then(async (
          ...
          if (selectedIndex == 2) {
            ...
            const { dates, ratings, comments } = await getDatesAndRatingsByWeekNumber(res, selectedWeek, selectedMonth ? selectedMonth : selectedMonth);
            ...
            console.log(dates,"datesdatesdatesdatesdatesdates");
  ...
  return (
    <SafeAreaView style={commonStyles.mainContainer}>
      ...
      <ScrollView>
        ...
        <Text style={styles.screenTitle}>Monitor your Symptoms</Text>
